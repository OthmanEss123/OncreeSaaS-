...
export default function AddManagerPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Appel à l'API pour créer le manager
      ...
      setErrors({ 
        submit: error.response?.data?.message || 'Erreur lors de la création du manager' 
      })
    } finally {
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between py-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Nouveau Manager</h1>
                <p className="text-gray-600">
                  Ajouter un nouveau manager pour {user?.company_name}
                </p>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                />
                <p className="mt-1 text-xs text-gray-500">Le rôle est automatiquement défini comme "Manager"</p>
              </div>
            </div>
          </motion.div>
          ...
          {success && (
            ...
            >
              <p className="text-sm text-green-600 flex items-center">
                ...
                Manager créé avec succès ! Redirection en cours...
              </p>
            </motion.div>
          )}
