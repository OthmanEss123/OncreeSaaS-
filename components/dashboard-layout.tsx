...
import { LayoutDashboard, Target, Users, UserCheck, FileText, CreditCard, Clock, Bell, Menu, X } from "lucide-react"

const sidebarItems = [
  { name: "Dashboard", href: "/dashboard", icon: LayoutDashboard },
  { name: "Missions", href: "/dashboard/missions", icon: Target },
  { name: "Clients", href: "/dashboard/clients", icon: Users },
  { name: "Consultants", href: "/dashboard/consultants", icon: UserCheck },
      ...
      >
        <div className="flex h-full flex-col">
          ...
          <div className="flex h-16 items-center justify-between px-6 border-b border-sidebar-border">
            <h1 className="text-xl font-bold text-sidebar-foreground">OncreeSaaS</h1>
